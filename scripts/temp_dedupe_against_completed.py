#!/usr/bin/env python3
"""
Temporary Deduplication Script - Remove triplets if any stage matches completed work

This script prevents duplicates by checking incoming images against files already
...
Usage:
    python scripts/temp_dedupe_against_completed.py <new_images_directory>

Example:
    python scripts/temp_dedupe_against_completed.py "Raw_Images_New"
"""
