...
def main():
    ...
    with REPORT_PATH.open("w") as f:
        ...
        for r in mojo1_rows[:50]:
            ...
            f.write(
                f"  Crop box:  x1={r['crop_x1']}, y1={r['crop_y1']}, x2={r['crop_x2']}, y2={r['crop_y2']}\n"
            )
            ...
            f.write(
                f"  → has_dims = {r['has_dims']} (MUST be False to trigger backfill)\n"
            )
        ...
        f.write("-" * 100 + "\n")
        f.write(
            f"{'Row':<6} {'Project':<8} {'Date':<12} {'Filename':<60} {'w0':<8} {'h0':<8}\n"
        )
        f.write("-" * 100 + "\n")
        ...
        for r in rows_to_report:
            ...
            f.write(
                f"{r['row']:<6} {r['project']:<8} {ts_short:<12} {fname_short:<60} {w0_display:<8} {h0_display:<8}\n"
            )
