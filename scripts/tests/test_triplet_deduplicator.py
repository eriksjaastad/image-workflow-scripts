...
class TestRemoveTripletFiles(unittest.TestCase):
    ...
    @patch("utils.triplet_deduplicator.safe_delete_paths")
    @patch("utils.triplet_deduplicator.find_all_companion_files")
    def test_removes_png_with_all_companions(
        self, mock_find_companions, mock_safe_delete
    ):
    ...
    @patch("utils.triplet_deduplicator.safe_delete_paths")
    @patch("utils.triplet_deduplicator.find_all_companion_files")
    def test_removes_complete_triplet_with_companions(
        self, mock_find_companions, mock_safe_delete
    ):
        ...
        triplet = {"stage1": stage1, "stage1_5": stage1_5, "stage2": stage2}
        removed = remove_triplet_files(triplet)
    ...
    @patch("utils.triplet_deduplicator.safe_delete_paths")
    @patch("utils.triplet_deduplicator.find_all_companion_files")
    def test_handles_missing_companions_gracefully(
        self, mock_find_companions, mock_safe_delete
    ):
    ...
    def test_continues_on_error(self, mock_find_companions, mock_safe_delete):
        ...
        mock_safe_delete.side_effect = [Exception("Permission denied"), [stage2]]
