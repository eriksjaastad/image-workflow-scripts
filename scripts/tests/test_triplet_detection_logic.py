...
def test_all_consecutive_combinations():
    ...
    try:
        ...
        test_cases = [
            ...
            ("1→1.5", ["20250705_214626_stage1_generated.png", "20250705_214953_stage1.5_face_swapped.png"], 1, [2]),
            ("1→2", ["20250705_214626_stage1_generated.png", "20250705_214953_stage2_upscaled.png"], 1, [2]),
            ("1→3", ["20250705_214626_stage1_generated.png", "20250705_214953_stage3_enhanced.png"], 1, [2]),
            ("1.5→2", ["20250705_214626_stage1.5_face_swapped.png", "20250705_214953_stage2_upscaled.png"], 1, [2]),
            ("1.5→3", ["20250705_214626_stage1.5_face_swapped.png", "20250705_214953_stage3_enhanced.png"], 1, [2]),
            ("2→3", ["20250705_214626_stage2_upscaled.png", "20250705_214953_stage3_enhanced.png"], 1, [2]),
            ("1→1.5→2", ["20250705_214626_stage1_generated.png", "20250705_214953_stage1.5_face_swapped.png", "20250705_215137_stage2_upscaled.png"], 1, [3]),
            ("1→1.5→3", ["20250705_214626_stage1_generated.png", "20250705_214953_stage1.5_face_swapped.png", "20250705_215137_stage3_enhanced.png"], 1, [3]),
            ("1→2→3", ["20250705_214626_stage1_generated.png", "20250705_214953_stage2_upscaled.png", "20250705_215137_stage3_enhanced.png"], 1, [3]),
            ("1.5→2→3", ["20250705_214626_stage1.5_face_swapped.png", "20250705_214953_stage2_upscaled.png", "20250705_215137_stage3_enhanced.png"], 1, [3]),
            ("1→1.5→2→3", ["20250705_214626_stage1_generated.png", "20250705_214953_stage1.5_face_swapped.png", "20250705_215137_stage2_upscaled.png", "20250705_215319_stage3_enhanced.png"], 1, [4]),
        ]
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                for group in groups:
                    ...
                    for i in range(len(stages) - 1):
                        assert stages[i+1] > stages[i], f"{description}: Stage {stages[i+1]} should be > {stages[i]}"
                        ...
                        if stages[i+1] != stages[i]:
                            ...
                            assert stages[i] in valid_stages, f"{description}: Stage {stages[i]} not in valid stages"
...
def test_backwards_stage_breaks_group():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert len(groups[0]) == 2, f"First group should have 2 files, got {len(groups[0])}"
            assert len(groups[1]) == 2, f"Second group should have 2 files, got {len(groups[1])}"
...
def test_time_gap_breaks_group():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert len(groups) == 1, f"Expected 1 qualifying group due to time gap, got {len(groups)}"
...
def test_duplicate_stage_ends_run():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert len(groups) == 2, f"Expected 2 groups split on duplicate stage, got {len(groups)}"
