...
def normalize_project(raw_project: Dict[str, Any], source_file: str) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        if "removeFileOnFinish" in raw_project:
            normalized["extra"]["removeFileOnFinish"] = raw_project["removeFileOnFinish"]
...
def main():
    ...
    if projects:
        ...
        for project in projects[:3]:
            ...
            print(f"  {project['project_id']}: {project['title']} ({status}, {images} images)")
