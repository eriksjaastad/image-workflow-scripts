...
Run on directories containing images (after character grouping):
  python scripts/02_web_character_sorter.py "Reviewed"
  python scripts/02_web_character_sorter.py "1100"
...
2. Character Sorting → THIS SCRIPT (scripts/02_web_character_sorter.py)
...
def create_app(folder: Path, hard_delete: bool = False) -> Flask:
...
def main() -> None:
    ...
    app = create_app(folder, args.hard_delete)
